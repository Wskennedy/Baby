...
const pengirim = "AYANG TOJI";
const nomorWa = "6287826124576" 
const textWa = "Ah bisa aja kamu"
const pesan = `Makasih udah mau jadi pacar aku,aku bahagia bisa sama kamu,pas awal-awal aku kira kita gk akan pernah bisa bersama,eh ternyata bisa,kalo bisa jangan pelit ngasih pap ya :),aku sebagai pacar kamu butuh yang namanya asupan kecantikan kamu`;

if (pengirim) {
  nama.innerHTML = pengirim;
  nama1.innerHTML = pengirim;
} else {
  nama.innerHTML = "AYANG TOJI";
  nama1.innerHTML = "AYANG TOJI";
}
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Halo baby,lagi ngapain sekarang ?',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`masukin nama kamu,aku lupa lagi`)
      }
      return { login }
    }
  }).then((result) => {
